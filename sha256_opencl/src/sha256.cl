...
{
    int pass_len_div_4 = pass_len/4;
    int pass_len_mod_4 = mod(pass_len, 4);
    int pass_len_in_bits = pass_len * 8;


    // printf("> pass_len=%d\n", pass_len);
    int num32Words = pass_len_div_4;
    if (pass_len_mod_4) // number of full 32-bit M-words
      num32Words++;
